...
// ================================================================================================
__device__ finline uint32 FloatFlip(uint32 f)
{
    uint32 mask = -int32(f >> 31) | 0x80000000;
    return f ^ mask;
}

__device__ finline void FloatFlipX(uint32 &f)
{
    uint32 mask = -int32(f >> 31) | 0x80000000;
    f ^= mask;
}
...
// ================================================================================================
__device__ finline uint32 IFloatFlip(uint32 f)
{
...
// Main radix sort
// ================================================================================================
__device__ static void RadixSort11(real32 *farray, real32 *sorted, uint32 elements)
{
    uint32 i;
